function createEntityUI(config){
 ...
 function renderEntity(id){
  ...
  sourcePanel.append(el('h2','',"Official updates & historical sources"),el('p','meta',e.changelogCount+" recorded official updates · Through 2026-09-10"));
