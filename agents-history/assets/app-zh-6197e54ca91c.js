...
(() => {
 ...
 function renderDetail(m){
  ...
  reading.replaceChildren();const head=el('div','reader-heading');head.append(el('h1','',m.id.slice(0,4)+' 年 '+Number(m.id.slice(5))+' 月'),el('p','',m.id==='2026-09'?'本月仅收录至 9 月 10 日':'月份不跳过，资料逐条展开'));reading.append(head);
